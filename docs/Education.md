...
<table style="width: 100%; border-collapse: collapse;">
  <tr>
    <td style="width: 80px; vertical-align: middle;">
      <img src="Images/UofA_logo.png" alt="UA Logo" width="60">
    </td>
    <td>
      <strong>Doctoral Student</strong><br>
        PhD in Environmental Health Sciences<br>
  ...
  <tr>
    ...
    <td>
      <strong>Master of Science (MS) [2016 - 2017]</strong><br>
  ...
  <tr>
    ...
    <td>
      <strong>Bachelor of Science (BSc) [2012 - 2016]</strong><br>
      Department of Public Health & Informatics<br>
      Jahangirnagar University, Savar, Dhaka, Bangladesh
    </td>
  </tr>
