...
<table>
  <tr>
    ...
    <td style="width:40%; text-align:center;">
      <img src="Images/LSHTM-logo.jpg" alt="LSHTM" width="400">
    </td>
    <td style="width:60%; vertical-align:top;">
      <p>
        <span style="font-size: 1.4em;"><strong><u><i>AS Co-Investigator</i></u></strong></span><br>
        <br>
        <Strong>Received:</Strong> $110,000<br>
        <Strong>Donor:</Strong> LSHTM (through Water for Women of DFAT)<br>
        <Strong>Project:</Strong> Inclusive pathways towards climate-resilient WASH in Bangladesh <br>
        <Strong>Timeline:</Strong> Jan 2023 - Dec 2024<br>  
        </p>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td style="width:40%; text-align:center;">
      <img src="Images/UNICEF.jpg" alt="Unicef" width="400">
    </td>
    <td style="width:60%; vertical-align:top;">
      <p>
        <span style="font-size: 1.4em;"><strong><u><i>AS Co-Investigator</i></u></strong></span><br>
        <br>
        <Strong>Received:</Strong> $118,525<br>
        <Strong>Donor:</Strong> UNICEF Bangladesh<br>
        <Strong>Project:</Strong> Developing a web-based WASH sector national planning, monitoring, and reporting system (NPMRS)<br>
        <Strong>Timeline:</Strong> Jan 2023 - Nov 2023<br>  
        </p>
  </tr>
</table>
