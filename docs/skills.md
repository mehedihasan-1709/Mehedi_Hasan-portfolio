...
<div style="display: flex; gap: 30px; align-items: center; flex-wrap: wrap; margin-top: 30px; font-family: 'Caveat', cursive; font-size: 1.2em;">
...
<div style="display: flex; flex-wrap: wrap; gap: 30px; justify-content: space-between; font-family: 'Caveat', cursive; font-size: 1.2em; margin-top: 30px;">
